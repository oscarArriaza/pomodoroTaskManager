...
(
    ...
    function()
    {
            ...
            section.onclick=function(event)
            {
                if (event.target.id === 'botonCrear')
                {
                    if(verificarQueLosCamposNoEstenVacios())
                    {
                        ...
                        crearTarea(idTarea,titulo.value,prioridad.value,idDeLaColumnaDondeSeCrearaLaTarea);
        ...
        function crearTarea(idTarea,titulo,prioridad,idDeLaColumnaDondeSeCrearaLaTarea)
        {
        ...
        function mostrarTareasGuardadas()
        {
            ...
            (
                tarea=>
                {
                    crearTarea(tarea.idTarea,tarea.titulo,tarea.prioridad,tarea.idDeLaColumnaDondeSeCrearaLaTarea);
                }
            );
        }
